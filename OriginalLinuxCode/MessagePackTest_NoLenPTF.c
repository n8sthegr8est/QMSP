...
int main(void){
	...
	ptxtF = malloc(sizeof(struct PlaintextFrame()) + 6);
	ptxtF->type   = 0x02;
	ptxtF->Length = 0x00;
	ptxtF->txtdta[0] = 0x48;
	ptxtF->txtdta[1] = 0x65;
